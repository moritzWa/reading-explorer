...
function Article({ item, key }: { item: DataForSEOBacklinkItem; key: number }) {
  ...
  <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
    ...
    <div className="bg-gray-100 p-4 border-b border-gray-200">
      <h2 className="text-xl font-semibold text-gray-900">{item.page_from_title}</h2>
    </div>
    ...
    <div className="bg-gray-100 p-4 border-t border-gray-200">
      <a href={item.url_from} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-900">
        Read more
      </a>
    </div>
  </div>
